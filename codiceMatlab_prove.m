...
Gm = 1 / ((1 + (1/14.670149535661091)*s) * (1 + (1/87.272727272727250)*s));
figure Name bode_Gm;
bode(Gm);
figure Name pzmap_Gm;
pzmap(Gm);

Gv = 1 / ((1 + (1/2.410261453282411)*s) * (1 + (1/0.040406650491007)*s));
figure Name bode_Gv;
bode(Gv);
figure Name pzmap_Gv;
pzmap(Gv);
...
tauz_1 = 1 / 4
tauz_2 = 1 / 0.040406650491007
figure Name R*G;
rlocus((G*(1 + tauz_1*s) * (1 + tauz_2*s)) / s);

figure Name R*G;
step((G*(1 + tauz_1*s) * (1 + tauz_2*s)) / s);

Rrl = ((1 + tauz_1*s)*(1 + tauz_2*s) / s);
Lrl = Rrl * G;
Frl = Lrl / 1 + Lrl;
figure Name F;
rlocus(Lrl);
